...
from .models import WorkoutSession, WorkoutSet, LifterProfile, WorkoutTemplate, WorkoutTemplateExercise
...
class RoutineTemplateTests(TestCase):
    ...
    def test_load_template(self):
        self.client.login(username='routine_user', password='password123')
        # Trigger dashboard once to seed templates
        ...
        # Verify sets were loaded into today's session
